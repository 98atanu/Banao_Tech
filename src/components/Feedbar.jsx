...
const Feedbar = () => {
  return (
    <div className="container2">
        <div className="d-none d-lg-flex justify-content-between mx-auto align-items-center container sticky-top" style={{maxWidth:"1024px",height:"68px", background:"#ffffff", borderTop:"1px solid rgba(0, 0, 0, 0.2)"}}>
